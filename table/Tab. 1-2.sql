...
FROM   CIS2.VW_DATA_ALL D 
     ...
     INNER JOIN 
       ...
       (
          SELECT  '1'  CODUL,  '?coala  profesionala' DENUMIRE  FROM DUAL UNION        
          SELECT  '2'  CODUL,  'Centrul de excelenaî'  DENUMIRE  FROM  DUAL UNION        
       ...
       (
    SELECT 'Total pe institu?ii de inva?amînt'  AS NUME_ROW, '01' AS NR_ROW, '0-1-2-3' AS TIP_INV FROM DUAL UNION
    SELECT 'Scoala profesionala'              AS NUME_ROW, '02' AS NR_ROW, '1'       AS TIP_INV FROM DUAL UNION    
    SELECT 'Centrul de excelenta'              AS NUME_ROW, '03' AS NR_ROW, '2'       AS TIP_INV FROM DUAL    
